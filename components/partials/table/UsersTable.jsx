        ...
        <div>
          <span className="inline-flex items-center">
            <span className="w-7 h-7 rounded-full ltr:mr-3 rtl:ml-3 flex-none bg-slate-600">
              <img
                src={user.image || "/assets/images/users/user-1.jpg"}
                alt={user.name}
...
const UsersTable = () => {
  ...
  // Add onEdit and onDelete to each user object for the table
      ...
      <Card>
        <div className="flex items-center justify-center py-12">
          <div className="text-center">
            ...
            <p className="mt-4 text-slate-600 dark:text-slate-300">Loading users...</p>
          </div>
        </div>
      </Card>
    );
